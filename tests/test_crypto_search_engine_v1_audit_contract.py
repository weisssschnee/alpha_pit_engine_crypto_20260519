...
def test_v4_campaign_uses_independent_runtime_and_receipt() -> None:
    config = _economic_campaign_config(ECONOMIC_SEARCH_V4_CAMPAIGN)

    assert config == {
        "epoch_id": "CRYPTO_SEARCH_ECONOMIC_V4_20260731",
        "runtime_date": "20260731",
...
def test_v5_campaign_uses_independent_runtime_and_receipt() -> None:
    config = _economic_campaign_config(ECONOMIC_SEARCH_V5_CAMPAIGN)

    assert config == {
        "epoch_id": "CRYPTO_SEARCH_ECONOMIC_V5_20260731",
        "runtime_date": "20260731",
