...
def contract_rows() -> list[dict[str, Any]]:
    specs = [
        ...
        ("L0_raw_source", "metrics_positioning", "OI, OI value, long-short ratios, taker ratio", "positioning/crowding state", "vendor 5m jitter / field-native latency fragility", "wrong_lag_future,time_shuffle"),
        ...
        rows.append(
            {
                ...
                "economic_role": role,
                "pit_rule": "+1h primary; field-native latency audit; fixed 2h delay prohibited",
...
def allowed_set() -> dict[str, Any]:
    return {
        ...
        "mandatory_constraints": [
            ...
            "+1h primary and field-native latency audit reported",
            "no label fields",
