...
def main() -> None:
    ...
    active = pd.DataFrame(
        [
            ...
            {"workstream": "a7ff_portfolio_replay", "current_stage": "A7FF-30A", "status": "pass_forensic_allowed_with_concentration_warning", "next": "A7FF-31 portfolio forensic/concentration contract"},
    ...
    lines = [
        ...
        "The next technical work is A7FF-31 portfolio forensic/concentration contract and A7FF-24R2 repaired queue tail rebuild.",
        "```",
    ]
    REPORT.write_text("\n".join(lines) + "\n", encoding="utf-8")
