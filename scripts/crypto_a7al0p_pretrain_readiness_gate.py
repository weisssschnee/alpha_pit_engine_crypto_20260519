...
def checks() -> tuple[list[dict[str, Any]], list[str]]:
    ...
    add("pit_lag_and_plus2h_contract", pit_ok, "pit_lag_incomplete", f"pit_rows={len(pit)}")
...
def main() -> None:
    ...
    manifest = {
        ...
        "warnings": [
            ...
            "Derived features are allowed only with lineage, PIT, +2h stress, neutralization, and controls",
