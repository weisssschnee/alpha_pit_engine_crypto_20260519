...
FAMILY_OVERRIDES: Mapping[str, str] = {
    ...
    "agg_trade_count": "quote_volume_activity",
    "underlying_trade_count": "quote_volume_activity",
    "quantity": "quote_volume_activity",
    "notional": "quote_volume_activity",
    "buy_agg_trade_count": "quote_volume_activity",
    "sell_agg_trade_count": "quote_volume_activity",
    "buy_quantity": "quote_volume_activity",
    "sell_quantity": "quote_volume_activity",
    "buy_notional": "quote_volume_activity",
    "sell_notional": "quote_volume_activity",
    "signed_aggressor_quantity": "quote_volume_activity",
    "signed_aggressor_notional": "quote_volume_activity",
    "volume_imbalance": "quote_volume_activity",
    "buy_sell_notional_ratio": "quote_volume_activity",
    "large_trade_count_ratio_100k_plus": "quote_volume_activity",
    "large_notional_ratio_100k_plus": "quote_volume_activity",
    "vwap": "price_level",
    "buy_vwap": "price_level",
    "sell_vwap": "price_level",
    "price_range_bps": "price_return",
    "close_to_open_bps": "price_return",
}
