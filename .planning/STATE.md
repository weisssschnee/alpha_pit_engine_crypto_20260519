...
**Last updated:** 2026-06-30 09:12 Asia/Hong_Kong
...
As of the last company-machine check on 2026-06-30 09:09-09:10:

- A7SEARCH5_R2 reports: `112 / 128`
- Active shard count: `10`
- Active shards: `s112` through `s121`
...
- Current memory guard status: free memory was about `15.85GB`, below the `18GB` start threshold, so no additional shards are started until memory recovers.
- CPU delta check confirmed all 10 active child workers are consuming CPU.
