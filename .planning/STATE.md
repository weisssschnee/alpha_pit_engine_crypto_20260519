...
`CRYPTO_SEARCH_ENGINE_V1_2_BALANCED_COLLISION_ARENA_COMPLETED`

The one-run fresh-state Search Engine V1.2 exception completed at producer
...
- Current research branch: `experiment/crypto-search-engine-v1-2-20260727`.
...
4. Do not launch another large search until separately authorized over an admitted new release. Latent search priority remains deferred after V1.2 and cannot influence budget.
...
evidence. No V1.1 or V1.2 arm qualifies for a future new-data Arena. Any next
