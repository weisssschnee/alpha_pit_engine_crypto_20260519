...
Generated from `config/crypto_architecture_control_registry_v1.json`. Registry SHA256: `6B48E715ED8980832CB3FE0D37EAAD1DDF337D144FCA1CC30358836F807401FB`.

Status: `PHASE_B0_CONTRACTS_ACCEPTED` / `PHASE_B0P_PARTIALLY_ACCEPTED` / `PRODUCTION_OBSERVATION_PARTIALLY_QUALIFIED` / `FROZEN_SIGNAL_BEHAVIOUR_QUALIFIED` / `HOLD_RESEARCH` / `PHASE_B1_FROZEN` / `SEALED_NO_NEW_FORWARD_READ`.
