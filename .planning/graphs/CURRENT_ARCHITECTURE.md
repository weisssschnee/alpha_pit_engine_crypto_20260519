...
Generated from `config/crypto_architecture_control_registry_v1.json`. Registry SHA256: `0F283421A804BAF699FCE3F05270A49C9A60ECEEE379296DE254C025C8CBE1D3`.

Status: `PHASE_B0_CONTRACTS_ACCEPTED` / `PHASE_B0P_PARTIALLY_ACCEPTED` / `PRODUCTION_OBSERVATION_PARTIALLY_QUALIFIED` / `HOLD_RESEARCH` / `PHASE_B1_FROZEN` / `SEALED_NO_NEW_FORWARD_READ`.
