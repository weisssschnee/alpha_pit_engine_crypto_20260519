# Crypto A7O-2C2 Bounded-Horizon Semantic Repair Audit

- generated_at: `2026-05-20T13:33:27Z`
- decision: `HOLD_A7O2C2_SEMANTIC_OR_HORIZON_FEASIBILITY_FAIL`
...
|:-----------------------------------------------|---------:|------------:|:-------|
| raw_unique_expr_ratio                          | 0.812902 |        0.9  | False  |
| effective_unique_ratio_after_horizon_bucketing | 0.764906 |        0.85 | False  |
| simplified_effective_unique_ratio_after_bucket | 0.764906 |        0.75 | True   |
...
A7O-2C2 does not authorize L1. If it passes, a separate A7O-2D authorization record is still required.