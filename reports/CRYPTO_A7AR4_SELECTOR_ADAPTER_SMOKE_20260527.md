...
Generated: 2026-05-27T04:26:09Z

## Decision

```text
PASS_A7AR4_SELECTOR_ADAPTER_SMOKE
```
...
```json
{
  "generated_at": "2026-05-27T04:26:09Z",
  "decision": "PASS_A7AR4_SELECTOR_ADAPTER_SMOKE",
  ...
  "selected_skeleton_count": 29,
  "selected_production_key_count": 32,
  "minimum_selected_skeleton_count": 20,
  "blockers": [],
  "a7al1_field_family_baseline_not_blocked_by_a7ar4": true,
  "authorizes_a7al2_small_formula_search_contract_drafting": true,
...
| --- | --- | --- | --- | --- |
| all_generated | 1000 | 31 | skeleton-7762e3f46e546cc2 | 0.077 |
| a7ar2_evaled | 96 | 31 | skeleton-ded8d0d5aade90e2 | 0.083333 |
| eligible_prediversity | 90 | 30 | skeleton-ded8d0d5aade90e2 | 0.088889 |
| selected | 32 | 29 | skeleton-746e1c41665c2005 | 0.09375 |

## Family Cap Audit

| cap_name | top_value | top_count | top_share | cap | status |
| --- | --- | --- | --- | --- | --- |
| top_formula_family_share | positioning_reversal | 6 | 0.1875 | 0.25 | PASS |
| top_skeleton_share | skeleton-746e1c41665c2005 | 3 | 0.09375 | 0.15 | PASS |
| top_production_key_share | crypto_formula_gen_v2_adapter::positioning_reversal::positioning|price::96 | 1 | 0.03125 | 0.2 | PASS |
| top_field_family_share | price | 16 | 0.25 | 0.25 | PASS |
...
| eligible_not_selected_by_caps_or_budget | 58 |
| selected_diversity_capped | 32 |
| low_activity_0bar | 6 |
...
| field_contract_all_present | PASS | fields=27 missing=0 |
...
| control_available_wrong_lag_future_1h | PASS | rows=96 active_ratio_median=0.974351 |
| control_available_wrong_lag_stale_24h | PASS | rows=96 active_ratio_median=0.972519 |
