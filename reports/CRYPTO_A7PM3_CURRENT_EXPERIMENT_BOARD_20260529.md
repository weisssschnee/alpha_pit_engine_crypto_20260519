...
Generated: 2026-05-31T17:37:09Z
...
| a7ff_family_diversification | A7FF-CORE2      | feature_subgraph_registry_ready_for_core3 | A7FF-CORE3 FormulaGen subgraph gate |
...
| A7FF-CORE3 FormulaGen subgraph gate               | governance/gate only; require FormulaGen to consume approved typed subgraphs and reject bypassed raw expressions; no generation/numeric/replay/search |
...
| A7FF-55R5F expanded sharded numeric execution      | blocked until FormulaGen subgraph gate is wired and audited                                                                   |
| A7FF-55R6 numeric response forensic / atlas repair | deprioritized until FormulaGen consumes typed subgraph registry; weak numeric response should not drive untyped atlas patches |
