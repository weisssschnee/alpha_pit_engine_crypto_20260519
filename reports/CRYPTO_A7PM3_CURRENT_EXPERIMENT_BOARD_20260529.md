...
Generated: 2026-05-31T16:57:33Z
...
| a7ff_family_diversification | A7FF-CORE0      | typed_ast_governance_ready_for_core1 | A7FF-CORE1 AST schema adapter       |
...
| A7FF-CORE1 AST schema adapter                     | governance/adapter only; round-trip expression string to typed AST JSON and back; no generation/numeric/replay/search |
...
| A7FF-55R6 numeric response forensic / atlas repair | deprioritized until typed AST governance is wired; current issue is generator/feature boundary, not only response forensic |
| A7FF-55R5F expanded sharded numeric execution      | blocked: A7FF-CORE0 requires typed AST adapter before expanding repaired atlas                                             |
