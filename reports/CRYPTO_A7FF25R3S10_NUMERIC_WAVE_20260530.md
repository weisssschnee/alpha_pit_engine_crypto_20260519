# CRYPTO A7FF-25R3S10 EXPANDED NUMERIC PROBE

Generated: 2026-05-30T08:35:58Z

## Decision

`HOLD_A7FF25R3S10_NO_ACTIVITY_OK_BLUEPRINTS`

A7FF-25R3S10 materializes the A7FF-7E selected blueprint queue and evaluates label response, controls, non-overlap statistics, and a dry portfolio marginal proxy. It is not formula search or alpha proof.
...
```json
{
  ...
  "blockers": [
    "no_activity_ok_blueprints"
  ],
  "decision": "HOLD_A7FF25R3S10_NO_ACTIVITY_OK_BLUEPRINTS",
  "executes_generation": false,
  "executes_numeric_probe": true,
  "executes_replay": false,
  "executes_search": false,
  "generated_at": "2026-05-30T08:35:58Z",
  ...
  "queue_limit": 200,
  "queue_offset": 0,
  "queue_path": "D:\\HermesWorker\\GDrive\\Project_V7_Rotation\\alpha_pit_engine_crypto_20260519_remote\\runtime\\a7ff24r_dry_generation_plan\\a7ff24r_company_shard_10_queue.csv",
